...
public class GrainPersistenceTestsRunner : OrleansTestingBase
{
    ...
    public GrainPersistenceTestsRunner(ITestOutputHelper output, 
    ...
    public async Task Grain_GrainStorage_Delete()
    {
        ...
        IGrainStorageTestGrain grain = GrainFactory.GetGrain<IGrainStorageTestGrain>(id);
    ...
    {
        long id = Random.Next();
        IGrainStorageTestGrainLongKey grain =
            GrainFactory.GetGrain<IGrainStorageTestGrainLongKey>(id);
    ...
    public async Task Grain_LongKeyExtended_GrainStorage_Read_Write()
    {
        ...
        IGrainStorageTestGrainLongExtendedKey
            grain = GrainFactory.GetGrain<IGrainStorageTestGrainLongExtendedKey>(id, extKey);
    ...
    public async Task Grain_GuidKeyExtended_GrainStorage_Read_Write()
    {
        ...
        IGrainStorageTestGrainGuidExtendedKey
            grain = GrainFactory.GetGrain<IGrainStorageTestGrainGuidExtendedKey>(id, extKey);
    ...
    public async Task Grain_Generic_GrainStorage_Read_Write()
    {
        ...
        IGrainStorageGenericGrain<int> grain =
            GrainFactory.GetGrain<IGrainStorageGenericGrain<int>>(id);
    ...
    public async Task Grain_NestedGeneric_GrainStorage_Read_Write()
    {
        ...
        IGrainStorageGenericGrain<List<int>> grain =
            GrainFactory.GetGrain<IGrainStorageGenericGrain<List<int>>>(id);
    ...
    public async Task Grain_Generic_GrainStorage_DiffTypes()
    {
        ...
        IGrainStorageGenericGrain<int> grain1 =
            GrainFactory.GetGrain<IGrainStorageGenericGrain<int>>(id1);

        IGrainStorageGenericGrain<string> grain2 =
            GrainFactory.GetGrain<IGrainStorageGenericGrain<string>>(id2);

        IGrainStorageGenericGrain<double> grain3 =
            GrainFactory.GetGrain<IGrainStorageGenericGrain<double>>(id3);
    ...
    public async Task Grain_GrainStorage_SiloRestart()
    {
        ...
        HostedCluster.InitializeClient();
