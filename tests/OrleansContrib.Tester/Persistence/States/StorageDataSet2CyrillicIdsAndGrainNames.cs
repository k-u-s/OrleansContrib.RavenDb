...
public class StorageDataSet2CyrillicIdsAndGrainNames<TStateData> : IEnumerable<object[]>
{
    ...
    private IEnumerable<object[]> DataSet { get; } = new[]
    {
        new object[]
        {
            ...
            (Func<IGrainFactory, GrainReference>)
            (grainFactory =>
                RandomUtilities.GetRandomGrainReference<string, IPersistenceDummyTestGrain>(grainFactory, Symbols, StringLength,
                    keyExtension: false)),
        ...
        new object[]
        {
            ...
            (Func<IGrainFactory, GrainReference>)
            (grainFactory =>
                RandomUtilities.GetRandomGrainReference<string, IPersistenceDummyTestGrain>(grainFactory, Symbols, StringLength, true)),
            new GrainState<TestStateGeneric1<TStateData>>
            {
                State = new TestStateGeneric1<TStateData>
                {
